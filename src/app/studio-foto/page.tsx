...
export default function Page() {
    return (
        <LocalizedServicePage
            ...
            contentSections={[
{ title: "Layanan Studio Foto di SS Foto", content: <div dangerouslySetInnerHTML={{ __html: "<div class=\"space-y-4\">\n<p>SS Foto menyediakan berbagai jenis sesi foto studio yang disesuaikan dengan kebutuhan pelanggan:</p>\n<ul class=\"list-disc pl-5 space-y-2\">\n<li><a href=\"/studio-foto-keluarga\" class=\"text-[#ea2423] font-semibold hover:underline\">Studio foto keluarga</a> — abadikan momen kebersamaan seluruh keluarga</li><li><a href=\"/studio-foto-wisuda\" class=\"text-[#ea2423] font-semibold hover:underline\">Studio foto wisuda</a> — foto wisuda profesional dengan toga atau busana formal</li><li><a href=\"/studio-foto-anak\" class=\"text-[#ea2423] font-semibold hover:underline\">Studio foto anak</a> — sesi foto khusus anak dengan suasana yang nyaman dan menyenangkan</li><li>Studio foto profil — foto profesional untuk LinkedIn, kartu nama, dan media sosial</li>\n</ul>\n</div>" }} /> },
