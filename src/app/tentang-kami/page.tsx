...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.ssfoto.co.id/tentang-kami",
  },
  openGraph: {
    title: "Tentang SS Foto - Lab Foto Profesional Sejak 1986",
    description:
    ...
    type: "website",
    url: "https://www.ssfoto.co.id/tentang-kami",
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {timeline.map((item, index) => (
                <div
                  key={index}
                  className={`relative flex flex-col lg:flex-row gap-8 items-center ${index % 2 === 0 ? "lg:flex-row-reverse" : ""
                    }`}
                >
                  {/* Content */}
                  <div className="lg:w-1/2">
                    <div
                      className={`bg-white rounded-2xl p-6 shadow-lg border border-gray-100 ${index % 2 === 0 ? "lg:text-right" : ""
                        }`}
                    >
                      <div
